...
/**
 * The SPA only routes `/`; `HomePage` reads `?steam=connected|error`
 * (see `src/hooks/useSteamCallback.ts`), shows a toast and opens the
 * Gaming overlay. Do not redirect to a sub-path: there is none.
 */
