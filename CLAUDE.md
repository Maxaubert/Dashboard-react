...
- **Still file-backed** (Phase 4 work in progress): `/api/home`, `/api/notes` (notes lives in the separate `notes_api.py` Flask sidecar on port 5001; it folds into `api.py` when migrated).
