 ...
 * bits: the `?steam=` return from the Steam OpenID callback, the Settings
 * modal (section show/hide + reorder), and the account controls. The
 * Settings button + account render into the bento top bar via `topActions`.
 *
