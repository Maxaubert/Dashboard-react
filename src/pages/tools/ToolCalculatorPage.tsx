...
/**
 * Calculator tool page. Standalone route under /tools/calculator. Uses
 * math.js for expression evaluation, supports symbolic functions, units,
 * and a button keypad alongside keyboard input.
 */
export function ToolCalculatorPage() {
  return (
    <div className="page">
      ...
      <PageHeader
        title="Kalkulator"
        subtitle="Regn ut tall, funksjoner og uttrykk."
      />
...
function CalculatorTool() {
  ...
  // 8-column key grid: numbers + operators + common functions
  const KEYS: Array<{ label: string; insert?: string; action?: () => void; accent?: boolean; span?: number }> = [
    ...
    { label: '×',  insert: '*' }, { label: 'x²', insert: '^2' }, { label: 'x³', insert: '^3' },
    { label: 'xʸ', insert: '^' }, { label: '%',  insert: '%' },

    { label: '1',  insert: '1' }, { label: '2',  insert: '2' }, { label: '3',  insert: '3' },
    { label: '−',  insert: '-' }, { label: 'sin', insert: 'sin(' }, { label: 'cos', insert: 'cos(' },
    { label: 'tan', insert: 'tan(' }, { label: 'log', insert: 'log10(' },

    { label: '0',  insert: '0' }, { label: '.',  insert: '.' }, { label: ',',  insert: ',' },
    { label: '+',  insert: '+' }, { label: 'ln',  insert: 'log(' }, { label: 'eˣ', insert: 'exp(' },
    { label: 'Σ',  insert: 'sum(' }, { label: '!',  insert: '!' },

    { label: '⌫',  action: backspace, span: 2 }, { label: 'C',  action: clear, accent: true, span: 2 },
  ];
